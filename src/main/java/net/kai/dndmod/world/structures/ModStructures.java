package net.kai.dndmod.world.structures;
...
public class ModStructures {
    ...
    public static void registerStructureFeatures() {
        SKY_STRUCTURES = Registry.register(Registry.STRUCTURE_TYPE, new Identifier(DnDMod.MOD_ID, "sky_structures"), () -> SkyStructures.CODEC);
    }
